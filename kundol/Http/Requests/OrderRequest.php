...
class OrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'payment_method' => $rule1.'|in:cash_on_delivery,paypal,stripe,banktransfer',
            'cc_number' => 'exclude_if:payment_method,cash_on_delivery,banktransfer|required|integer',
            'cc_expiry_month' => 'exclude_if:payment_method,cash_on_delivery,banktransfer|required|integer',
            'cc_expiry_year' => 'exclude_if:payment_method,cash_on_delivery,banktransfer|required|integer',
            'cc_cvc' => 'exclude_if:payment_method,cash_on_delivery,banktransfer|required|integer',
