                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="form-start">
                                    <form>
                                        <label class="first-label" for="email">Username</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationCustomUsername"
                                                placeholder="Enter Your Name" aria-describedby="inputGroupPrepend" required>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <ul class="contact-logo pl-0 mb-0">
                                            ...
                                            <li> <i class="fas fa-map-marker"></i><br>ADDRESS
                                            </li>
                                    ...
                                    <div class="col-6 right">
                                        <ul class="contact-info  pl-0 mb-0">
                                            <li>
                                                <font>
                                                    <a href="javascript:void(0)">888-9636-6000</a><br> <a href="javascript:void(0)">888-9636-6000</a>
                                                </font>
                                            </li>
                                            <li>
                                                <font><a href="javascript:void(0)">Ecommerce<br>Demo Store 3654123</a></font>
                                            </li>
                                            <li>
                                                <font><a href="javascript:void(0)">abc@ecommerce.com</a><br><a href="javascript:void(0)">etc@ecommerce.com</a>
                                                </font>
                                            </li>
                                            <li>
                                                <font><a href="javascript:void(0)">23456789</a><br><a href="javascript:void(0)">123456</a> </font>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
