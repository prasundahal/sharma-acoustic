    ...
    <div class="content">
      ...
      <div class="pro-counter">
          <div class="input-group item-quantity">
              ...
              <input type="text" id="quantity22" name="quantity" class="form-control" value="10">
              
              <span class="input-group-btn">
                  <button type="button" value="quantity22" class="quantity-plus22 btn" data-type="plus" data-field="">
                      <i class="fas fa-plus"></i>
                  </button>
              
                  <button type="button" value="quantity22" class="quantity-minus22 btn" data-type="minus" data-field="">
