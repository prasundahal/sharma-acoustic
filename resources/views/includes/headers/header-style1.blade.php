  ...
  <div class="container">
      <div class="nav-logo d-flex justify-content-between align-items-center">
          ...
          <div class="cart-wishlist d-xl-block">
              <ul class="d-flex m-0">
                  <li class="nav-item">
                      <a class="nav-link add-on px-xl-2 px-lg-1" data-toggle="modal" data-target="#nav-cart">
                          <span class="mr-1"><i class="fa fa-shopping-bag" aria-hidden="true"></i></span> Cart <sup class="cart-item-no text-white px-2">2</sup>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link add-on px-xl-2 px-lg-1" href="under-construction.html">
                          <span class="mr-1"><i class="fa fa-heart-o" aria-hidden="true"></i></span> Wishlist
                      </a>
                  </li>
              </ul>
          </div>
