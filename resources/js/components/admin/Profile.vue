...
export default {
    ...
    methods: {
        fetchUser() {
            ...
            axios.get('/api/admin/user/1', config)
                .then(res => {
        ...
        updateProfile() {
            ...
            axios.put('/api/admin/user/1',{name:this.user.name,email:this.user.email,password:this.user.password,confirm_password:this.user.confirm_password} ,config)
                .then(res => {
                    if (res.data.status == "Success") {
